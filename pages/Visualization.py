...
explanation_3index = """
<p style='color:gray;'>
<b>- SVI:</b> 공연 규모·장르 구성 영향으로 봄·가을에 높아지고 여름에 낮아지는 공연 시즌 패턴을 보입니다.<br>
<b>- HLI:</b> 방문객·주차·시설 이용이 증가하는 5월과 10월에 혼잡이 가장 크게 상승하는 현장 부하 패턴을 나타냅니다.<br>
<b>- AQHI:</b> 겨울철엔 계절 보정으로 낮고, 3월 이후 외기 미세먼지·온습도 변동으로 상승하며 여름·가을에는 환기·냉방 안정 효과와 외기 악화 요인이 균형을 이루며 일정한 수준을 유지합니다.
</p>
"""
